...
class LoaderDoubleBounce extends StatefulWidget {
  const LoaderDoubleBounce({
    Key key,
    this.color,
    this.size = 50.0,
    this.itemBuilder,
  ...
  @override
  _LoaderDoubleBounceState createState() => _LoaderDoubleBounceState();
}

class _LoaderDoubleBounceState extends State<LoaderDoubleBounce> with SingleTickerProviderStateMixin {
